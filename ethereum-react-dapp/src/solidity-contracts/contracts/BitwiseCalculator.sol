...
contract BitwiseCalculator {
    function calculate(
        ...
        if (keccak256(abi.encodePacked(operator)) == keccak256(abi.encodePacked("AND"))){
            return bitwiseAND(x, y);
        }
        else if (keccak256(abi.encodePacked(operator)) == keccak256(abi.encodePacked("OR"))){
            return bitwiseOR(x, y);
        }
        else if (keccak256(abi.encodePacked(operator)) == keccak256(abi.encodePacked("NOT"))){
            return bitwiseNOT(x);
        }
        else if (keccak256(abi.encodePacked(operator)) == keccak256(abi.encodePacked("NAND"))){
            return bitwiseNAND(x, y);
        }
        else if (keccak256(abi.encodePacked(operator)) == keccak256(abi.encodePacked("NOR"))){
            return bitwiseNOR(x, y);
        }
        else if (keccak256(abi.encodePacked(operator)) == keccak256(abi.encodePacked("XOR"))){
